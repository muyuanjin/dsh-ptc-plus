...
test('presents one coherent persistent REPL contract to the model', async (t) => {
  ...
  assert.match(guidance, /Repeated top-level `function`\/`class` declarations are rejected/)
  assert.match(guidance, /top-level `const`\/`let` function or class expressions/)
